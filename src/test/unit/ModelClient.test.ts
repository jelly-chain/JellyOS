...
import { resolveModelChain } from '../../runner/ModelClient';
...
describe('ModelClient', () => {
  ...
  describe('technical analysis exports', () => {
    it('exports fullAnalysis function', async () => {
      const { fullAnalysis } = await import('../../tools/TechnicalAnalysis');
      expect(typeof fullAnalysis).toBe('function');
    });

    it('exports indicator functions', async () => {
      const { rsi, macd, ema, sma, bollingerBands, atr } = await import('../../tools/TechnicalAnalysis');
  ...
  describe('TechnicalAnalysis', () => {
    it('calculates SMA correctly', async () => {
      const { sma } = await import('../../tools/TechnicalAnalysis');
    ...
    it('calculates RSI on sufficient data', async () => {
      const { rsi } = await import('../../tools/TechnicalAnalysis');
